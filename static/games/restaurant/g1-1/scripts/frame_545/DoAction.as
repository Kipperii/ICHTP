...
{
   s1.attachSound("Sound_Time_GameOver");
   btnTimeOutFail._visible = false;
   btnTimeOutFailGameOver._visible = true;
}
else
{
   s1.attachSound("Sound_Time_Next");
   btnTimeOutFail._visible = true;
   btnTimeOutFailGameOver._visible = false;
}
s1.start();
